    ...
    <section className='antialiased'>
...

      {
        ...
        <section className="relative w-full container mx-auto py-10">
          <OwlCarousel className='owl-theme' items={1} dots={true} loop autoplay>
            {
              informations.map((information, index) =>
                <div key={index} className="relative item h-56 md:h-96">
                  <img src={getImages(information.images)} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                </div>
              )
            }
          </OwlCarousel>
